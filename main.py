...
class Game:
	...
	def __create_enemy_grid(self):
		...
		enemy_board_layout += [[sg.Button('', image_data=self.enemy_board[row][col], button_color=(sg.theme_background_color(), sg.theme_background_color()), size = (4,2), pad=(0,0), key=(row,col)) for col in range(10)] for row in range(10)]
